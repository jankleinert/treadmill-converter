...
*/
var aa=__webpack_require__(5),ba=__webpack_require__(2),m=__webpack_require__(12),p=__webpack_require__(4),v=__webpack_require__(3),da=__webpack_require__(13),ea=__webpack_require__(14),fa=__webpack_require__(15),ha=__webpack_require__(6);
...
var _MphPanel = __webpack_require__(57);

var _MphPanel2 = _interopRequireDefault(_MphPanel);

var _KphPanel = __webpack_require__(58);

var _KphPanel2 = _interopRequireDefault(_KphPanel);
...
var App = function (_React$Component) {
  ...
  _createClass(App, [{
    key: 'handleClick',
    value: function handleClick(direction, unit) {
      var _this2 = this;
      ...
      if (direction.indexOf("up") !== -1) {
        ...
        if (unit.indexOf("mph") !== -1) {
          ...
          _axios2.default.get("/convert/?mph=" + newMph).then(function (response) {
          ...
          _axios2.default.get("/convert/?kph=" + newKph).then(function (response) {
            console.log(response.data);
            _this2.setState({
    ...
    key: 'renderMphPanel',
    value: function renderMphPanel(i) {
      var _this3 = this;

      return _react2.default.createElement(_MphPanel2.default, {
        value: this.state.mph,
        onUpClick: function onUpClick() {
          return _this3.handleClick("up", "mph");
        },
        onDownClick: function onDownClick() {
          return _this3.handleClick("down", "mph");
        }
      });
    }
  }, {
    key: 'renderKphPanel',
    value: function renderKphPanel(i) {
      var _this4 = this;

      return _react2.default.createElement(_KphPanel2.default, {
        value: this.state.kph,
        onUpClick: function onUpClick() {
          return _this4.handleClick("up", "kph");
        },
        onDownClick: function onDownClick() {
          return _this4.handleClick("down", "kph");
        }
      });
    }
  }, {
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'treadmill-panels' },
          _react2.default.createElement(
            'div',
            { className: 'treadmill-panel' },
            this.renderMphPanel()
          ),
          _react2.default.createElement(
            'div',
...
function halfStepIncrement(value) {
  ...
  if (remainder < 0.5) {
    // round to floor of value + 0.5
    return (Math.floor(value) + 0.5).toFixed(1);
  } else {
    // round to ceiling of value
...
function halfStepDecrement(value) {
  ...
  if (remainder > 0.5) {
    // round to floor of value + 0.5
    return (Math.floor(value) + 0.5).toFixed(1);
  } else if (remainder >= 0.5 && remainder > 0) {
    // round to floor of value
...
// module
exports.push([module.i, "body {\n  font: 18px \"Source Code Pro\", monospace;\n  margin: 20px;\n\n}\n\nol, ul {\n  padding-left: 30px;\n}\n\n.treadmill {\n  width: 70%;\n  min-width: 340px;\n  height: auto;\n  background-color: #ddd;\n  border-radius: 30px;\n  position: relative;\n}\n\n.treadmill-panels {\n  width: 320px;\n  height: auto;\n  margin: 0 auto;\n  position: relative;\n  padding-top: 20px;\n  padding-bottom: 20px;\n\n}\n\n.treadmill-panel {\n  width: 300px;\n  background-color: #555;\n  margin: 0px 0px 10px 0px;\n  padding: 15px 10px 15px 10px;\n  color: cyan;\n  font-size: 36px;\n  text-align: center;\n  border-radius: 15px;\n}\n\n\n.treadmill-panel:after {\n  clear: both;\n  content: \"\";\n  display: table;\n}\n\n.treadmill-wrapper {\n  display: inline-block;\n}\n\n.treadmill-title {\n  color: #fff;\n  font-size: 20px;\n  padding-bottom: 10px;\n}\n\n.treadmill-control {\n  background: #eee;\n  border: 1px solid #999;\n  font-size: 32px;\n  font-weight: bold;\n  line-height: 48px;\n  height: 48px;\n  margin-left: 10px;\n  padding: 0;\n  text-align: center;\n  width: 48px;\n  border-radius: 5px;\n  color: #555;\n\n}\n\n.treadmill-control:focus {\n  outline: none;\n}\n\n.kbd-navigation .treadmill-control:focus {\n  background: #ddd;\n}\n\n.treadmill {\n  display: block;\n  /*flex-direction: row;*/\n}\n\n\n", ""]);
...
var MphPanel = function (_React$Component) {
	_inherits(MphPanel, _React$Component);

	function MphPanel() {
		_classCallCheck(this, MphPanel);

		return _possibleConstructorReturn(this, (MphPanel.__proto__ || Object.getPrototypeOf(MphPanel)).call(this));
	}

	_createClass(MphPanel, [{
		key: 'render',
		value: function render() {
			return _react2.default.createElement(
				'div',
				{ className: 'treadmill-wrapper' },
				_react2.default.createElement(
					'div',
					{ className: 'treadmill-title' },
					'Imperial (mph)'
				),
				_react2.default.createElement(
					'span',
				...
				_react2.default.createElement(
					'button',
					{ className: 'treadmill-control', onClick: this.props.onUpClick },
					'+'
				),
				_react2.default.createElement(
					'button',
					{ className: 'treadmill-control', onClick: this.props.onDownClick },
					'-'
				)
			);
		}
...
var KphPanel = function (_React$Component) {
	_inherits(KphPanel, _React$Component);

	function KphPanel() {
		_classCallCheck(this, KphPanel);

		return _possibleConstructorReturn(this, (KphPanel.__proto__ || Object.getPrototypeOf(KphPanel)).call(this));
	}

	_createClass(KphPanel, [{
		key: 'render',
		value: function render() {
			return _react2.default.createElement(
				'div',
